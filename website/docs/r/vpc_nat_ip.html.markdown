...
For information about Nat Gateway Nat Ip and how to use it, see [What is Nat Ip](https://www.alibabacloud.com/help/doc-detail/281976.htm).
...
* `ipv4_prefix` - (Optional, ForceNew, Available since v1.273.0) The IPv4 prefix address block to be created.
...
* `nat_ip_id` - The ID of the NAT IP address instance to be queried.
