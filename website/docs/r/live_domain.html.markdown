...
variable "domain_name" {
  default = "antang-terraform-domain20251216090912120404"
}
...
* `create_time` - When the live domain name was created. The format is:  yyyy-MM-dd T  HH:mm:ss Z(UTC time).
...
```shell
$ terraform import alicloud_live_domain.example <id>
```