...
* `domain_infos` - (Optional, List) The domain name information. See [`domain_infos`](#domain_infos) below.
...
The domain_infos supports the following:
* `domain_id` - (Optional) The domain name ID.
