...
For information about RDS Custom Deployment Set and how to use it, see [What is Custom Deployment Set](https://next.api.alibabacloud.com/document/Rds/2014-08-15/CreateRCDeploymentSet).
...
* `tags` - (Optional, Map, Available since v1.272.0) A list of tags.
...
* `update` - (Defaults to 5 mins) Used when update the Custom Deployment Set.
...
```shell
$ terraform import alicloud_rds_custom_deployment_set.example <custom_deployment_set_id>
```