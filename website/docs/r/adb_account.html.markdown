...
* `tag` - (Optional, ForceNew, List, Available since v1.271.0) The tag of the resource See [`tag`](#tag) below.

### `tag`

The tag supports the following:
* `key` - (Optional, ForceNew, Available since v1.271.0) The key of the tags
* `value` - (Optional, ForceNew, Available since v1.271.0) The value of the tags
