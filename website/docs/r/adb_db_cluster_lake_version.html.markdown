...
AnalyticDB for MySQL Lakehouse Edition cluster  .
...
* `audit_log_status` - (Optional, Available since v1.273.0) The status of SQL audit logging. Valid values:
...
* `auto_renewal_period` - (Optional, Int, Available since v1.273.0) The auto-renewal period. The default value is 1. Valid values are as follows:
...
* `auto_renewal_period_unit` - (Optional, Available since v1.273.0) The auto-renewal period unit. Valid values:
  - Year: year.
  - Month: month.

-> **NOTE:** This parameter only takes effect when other resource properties are also modified. Changing this parameter alone will not trigger a resource update.

* `auto_renewal_status` - (Optional, Available since v1.273.0) The auto-renewal status. Valid values:
...
* `capacity` - (Optional, Int, Available since v1.273.0) The size of the lake storage acceleration cache space, in GB.
...
* `db_cluster_network_type` - (Required, ForceNew, Available since v1.273.0) Cluster network type. Only `VPC` (Virtual Private Cloud) is supported.
* `db_cluster_version` - (Required, ForceNew) The version of the lakehouse cluster. Valid value: **5.0**.
* `db_cluster_ip_array_attribute` - (Optional, Available since v1.273.0) Whitelist group attribute. The default value is empty.  
...
* `db_cluster_ip_array_name` - (Optional, Available since v1.273.0) The name of the IP address whitelist group. By default, operations apply to the Default group.
...
* `db_version` - (Optional, Available since v1.273.0) The target kernel version to which you want to upgrade.
...
* `enable_compaction_service` - (Optional, Available since v1.273.0) Specifies whether to enable the remote build service.
...
* `enable_essd_cache` - (Optional, Computed, Available since v1.273.0) Specifies whether to enable ESSD cache.
* `enable_lake_cache` - (Optional, Available since v1.273.0) Specifies whether to enable lake storage acceleration.
* `enable_ssl` - (Optional, Computed, Available since v1.245.0) Specifies whether to enable SSL encryption for connections. Valid values:
  - `true`: Enabled.
  - `false`: Disabled.
* `engine_type` - (Optional, Available since v1.273.0) The compute engine type. Valid values:
  - XIHE (`default`): Xihe compute engine.
  - SPARK: Spark compute engine.

-> **NOTE:** This parameter only takes effect when other resource properties are also modified. Changing this parameter alone will not trigger a resource update.

* `essd_cache_size` - (Optional, Int, Available since v1.273.0) ESSD cache size, in GB.
...
* `maintain_time` - (Optional, Available since v1.273.0) The maintenance window for the cluster, in the format hh:mmZ-hh:mmZ.

-> **NOTE:**  The time window must be exactly one hour long and aligned to the hour.

* `modify_mode` - (Optional, Available since v1.273.0) The method for modifying the IP whitelist. Valid values:
...
* `switch_mode` - (Optional, Int, Available since v1.273.0) The execution time. Valid values:
...
* `tags` - (Optional, Map, Available since v1.273.0) The tag information of the cluster.
* `used_time` - (Optional, Available since v1.273.0) Specifies the subscription duration for a subscription cluster. Valid values:  
