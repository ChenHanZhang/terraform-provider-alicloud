...
* `crl_day` - (Optional, ForceNew, Computed, Int, Available since v1.269.0) The interval (in days) for updating the Certificate Revocation List (CRL).
...
* `certificate_type` - The type of the CA.
