...
For information about Alikafka Instance and how to use it, see [What is Instance](https://www.alibabacloud.com/help/en/message-queue-for-apache-kafka/latest/api-alikafka-2019-09-16-startinstance).
...
### Deleting ` alicloud_alikafka_instance` or removing it from your configuration

The ` alicloud_alikafka_instance` resource allows you to manage  `paid_type = "0,4"`  instance, but Terraform cannot destroy it.
...
* `confluent_config` - (Optional, Set, Available since v1.274.0) Confluent component related configuration.


-> **NOTE:**  Must be passed when creating a Confluent series instance.
 See [`confluent_config`](#confluent_config) below.
* `cross_zone` - (Optional, Available since v1.274.0) Whether to cross Availability Zones.
...
* `deploy_module` - (Required, Available since v1.274.0) Deployment mode. Value:
  - `vpc`:VPC instance
...
* `duration` - (Optional, Int, Available since v1.274.0) Duration of purchase. The unit is a month. The default value is 1. Value:
  - **1 to 12 * *
...
* `eip_model` - (Optional, Available since v1.274.0) Whether the public network is required. The values are as follows:
...
* `instance_id` - (Optional, ForceNew, Computed, Available since v1.274.0) The ID of the instance.
* `instance_name` - (Optional, Available since v1.274.0) Note name
...
* `is_eip_inner` - (Optional, Available since v1.274.0) Whether to support EIP. Value:
...
* `is_force_selected_zones` - (Optional, Available since v1.274.0) Whether to force deployment in the selected zone

-> **NOTE:** This parameter only takes effect when other resource properties are also modified. Changing this parameter alone will not trigger a resource update.

* `is_set_user_and_password` - (Optional, Available since v1.274.0) Whether to set a new user name and password. Value:
...
* `notifier` - (Optional, Available since v1.274.0) Alert contacts

-> **NOTE:** This parameter only takes effect when other resource properties are also modified. Changing this parameter alone will not trigger a resource update.

* `order_id` - (Optional, ForceNew, Available since v1.274.0) The order ID. You can click [order order](https://usercenter2.aliyun.com/order/list? pageIndex = 1 & pageSize = 20). 
...
* `partition_num_of_buy` - (Optional, Int, Available since v1.274.0) PartitionNumOfBuy
* `password` - (Optional, Available since v1.274.0) User password.
Only public/VPC instances are supported.
...
* `serverless_config` - (Optional, Set, Available since v1.274.0) The settings of the Serverless instance. Must be passed when creating a Serverless instance. See [`serverless_config`](#serverless_config) below.
...
* `update_default_topic_partition_num` - (Optional, Available since v1.274.0) Whether to modify the default value of the automatically created Topic. Note that this parameter and the operation parameter cannot be passed at the same time.

-> **NOTE:** This parameter only takes effect when other resource properties are also modified. Changing this parameter alone will not trigger a resource update.

* `user_phone_num` - (Optional, Available since v1.274.0) Early warning contact mobile phone number

-> **NOTE:** This parameter only takes effect when other resource properties are also modified. Changing this parameter alone will not trigger a resource update.

* `username` - (Optional, Available since v1.274.0) User name.
Only public/VPC instances are supported.
...
* `connect_cu` - (Optional, Int, Available since v1.274.0) The number of CPU cores of the Connect component.
* `connect_replica` - (Optional, Int, Available since v1.274.0) The number of copies of the Connect component.
* `control_center_cu` - (Optional, Int, Available since v1.274.0) The number of CPU cores of the ControlCenter component.
* `control_center_replica` - (Optional, Int, Available since v1.274.0) The number of copies of the ControlCenter component.
* `control_center_storage` - (Optional, Int, Available since v1.274.0) The disk capacity of the ControlCenter component. Unit of GB.
* `kafka_cu` - (Optional, Int, Available since v1.274.0) The number of Kafka Broker CPU cores.
* `kafka_replica` - (Optional, Int, Available since v1.274.0) Number of copies of Kafka Broker.
* `kafka_rest_proxy_cu` - (Optional, Int, Available since v1.274.0) The number of CPU cores of the KafkaRestProxy component.
* `kafka_rest_proxy_replica` - (Optional, Int, Available since v1.274.0) Number of copies of the KafkaRestProxy component.
* `kafka_storage` - (Optional, Int, Available since v1.274.0) The disk capacity of the Kafka Broker. Unit of GB.
* `ksql_cu` - (Optional, Int, Available since v1.274.0) KsqlDB component
The number of CPU cores.
* `ksql_replica` - (Optional, Int, Available since v1.274.0) Number of copies of the KsqlDB component.
* `ksql_storage` - (Optional, Int, Available since v1.274.0) KsqlDB component disk capacity. Unit of GB.
* `schema_registry_cu` - (Optional, Int, Available since v1.274.0) The number of CPU cores of the schemaregery component.
* `schema_registry_replica` - (Optional, Int, Available since v1.274.0) The number of copies of the schemaregery component.
* `zoo_keeper_cu` - (Optional, Int, Available since v1.274.0) The number of CPU cores of the ZooKeeper component.
* `zoo_keeper_replica` - (Optional, Int, Available since v1.274.0) Number of copies of the ZooKeeper component.
* `zoo_keeper_storage` - (Optional, Int, Available since v1.274.0) ZooKeeper component disk capacity. Unit of GB.

### `serverless_config`

The serverless_config supports the following:
* `reserved_publish_capacity` - (Optional, Int, Available since v1.274.0) The specification of the reserved sending traffic. Only the incoming integer is supported. The minimum value is 60.
...
* `reserved_subscribe_capacity` - (Optional, Int, Available since v1.274.0) The reserved consumption traffic specification. Only an integer can be passed in. The minimum value is 20.
...
* `domain_endpoint` - The domain name of the default access point.
...
* `region_id` - RegionId.
* `sasl_domain_endpoint` - The domain name access point of the SASL access point.
* `ssl_domain_endpoint` - The domain name of the SSL access point.
...
```shell
$ terraform import  alicloud_alikafka_instance.example <instance_id>
```