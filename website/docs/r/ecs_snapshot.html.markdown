...
* `source_region_id` - (Required, Available since v1.270.0) The region of the source snapshot.

-> **NOTE:** The parameter is immutable after resource creation. It only applies during resource creation and has no effect when modified post-creation.

* `source_snapshot_id` - (Required, Available since v1.270.0) This property does not have a description in the spec, please add it before generating code.
