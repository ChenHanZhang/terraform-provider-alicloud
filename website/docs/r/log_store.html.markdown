...
* `project` - (Deprecated since v1.269.0). Field 'project' has been deprecated from provider version 1.269.0. New field 'project_name' instead.
* `name` - (Deprecated since v1.269.0). Field 'name' has been deprecated from provider version 1.269.0. New field 'logstore_name' instead.
