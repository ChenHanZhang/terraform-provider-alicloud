...
* `order_type` - (Optional, Computed, Available since v1.275.0) The entity that pays the fees of the network instance. Valid values:
...
* `transit_router_attachment_name` - (Deprecated since v1.275.0). Field 'transit_router_attachment_name' has been deprecated from provider version 1.275.0. New field 'transit_router_vpc_attachment_name' instead.
