...
-> **NOTE:**  separate multiple IP addresses with commas. All IP addresses in the whitelist support 1000 IP addresses or address segments.
...
```shell
$ terraform import alicloud_mongodb_global_security_ip_group.example <global_security_group_id>
```