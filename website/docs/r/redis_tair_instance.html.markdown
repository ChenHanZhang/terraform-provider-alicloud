...
* `engine_version` - (Optional, Computed) The database engine version. Default value: **1.0**. The parameter value varies based on the Tair instance series.
...
* `tde_status` - (Optional, Computed, Available since v1.273.0) Specifies whether to enable Transparent Data Encryption (TDE). Valid value: `Enabled`.
