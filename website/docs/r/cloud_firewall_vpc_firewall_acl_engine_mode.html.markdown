...
* `member_uid` - (Optional, ForceNew) The ID of the member account that belongs to the current Alibaba Cloud account.
* `strict_mode` - (Required, Int) Specifies whether to enable strict mode.
  - 1: Enable strict mode.
  - 0: Disable strict mode.
* `vpc_firewall_id` - (Required, ForceNew) The ID of the access control policy group for the VPC firewall.

Valid values:
  - If the VPC firewall protects a Cloud Enterprise Network (CEN) instance, set this parameter to the CEN instance ID.
