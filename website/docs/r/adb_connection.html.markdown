...
Access connection for an AnalyticDB instance. You can use the connection string to access the AnalyticDB instance.
...
* `connection_string_prefix` - (Optional, Available since v1.274.0) Prefix of the public endpoint.  
