...
* `connection_string` - (Optional, Computed) The connection string of the cluster
* `connection_string_prefix` - (Optional, ForceNew, Available since v1.271.0) The prefix of the endpoint
* `db_cluster_id` - (Required, ForceNew) The DBCluster ID
* `port` - (Optional, ForceNew, Computed, Int) The connection port
