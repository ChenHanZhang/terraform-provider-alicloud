...
* `auto_use_coupon` - (Optional, Available since v1.277.0) Specifies whether to automatically apply coupons. Valid values:
* `true` (default): Yes.
* `false`: No.
...
* `deletion_protection` - (Optional, Available since v1.277.0) Specifies whether to enable deletion protection. Valid values:  
...
* `enable_jumbo_frame` - (Optional, Available since v1.277.0) Whether the instance has the Jumbo Frame feature enabled. Parameter value range:
...
* `private_ip_address` - (Optional, ForceNew, Available since v1.277.0) The private IP address of the instance. When setting a private IP address for an ECS instance of the VPC type, you must select the free CIDR block of the vSwitch (VSwitchId).
* `promotion_code` - (Optional, Available since v1.277.0) The coupon code.  

-> **NOTE:** This parameter is only evaluated during resource creation and update. Modifying it in isolation will not trigger any action.

* `reboot` - (Optional, Available since v1.277.0) Whether the instance is restarted. Value Description:
  - `true`: Restart
  - `false` (default): do not restart

-> **NOTE:** This parameter only takes effect when other resource properties are also modified. Changing this parameter alone will not trigger a resource update.

* `reboot_time` - (Optional, Available since v1.277.0) The scheduled restart time for the instance.
...
* `reboot_when_finished` - (Optional, Available since v1.277.0) Specifies whether to restart the instance immediately after configuration changes are completed. Valid values:
  - `true` (default): Yes.
  - `false`: No.
...
* `user_data` - (Optional, ForceNew, Available since v1.277.0) Custom data for the instance. The raw data can be up to 32 KB in size.  
...
```  
* `user_data_in_base64` - (Optional, Available since v1.277.0) Specifies whether the custom data is Base64-encoded.
  - `true`: Yes.
  - `false` (default): No.
...
* `device` - (Optional, ForceNew, Available since v1.277.0) The mount point of the data disk.
...
* `encrypted` - (Optional, ForceNew, Available since v1.277.0) Specifies whether to encrypt the cloud disk. Valid values:
  - `true`: Yes.
  - `false` (default): No.
...
* `snapshot_id` - (Optional, ForceNew, Available since v1.277.0) The snapshot used to create the data disk.
...
* `category` - (Optional, ForceNew) System disk category. Valid values:
  ...
  - `cloud_essd` (default): ESSD cloud disk.
  - `cloud_auto`: High-performance cloud disk.
* `performance_level` - (Optional, ForceNew, Available since v1.277.0) Performance level for ESSD cloud disks. For details about performance differences among ESSD cloud disks, see [ESSD Cloud Disks](https://help.aliyun.com/document_detail/2859916.html). Valid values:
  - `PL0`
  - `PL1` (default)
  - `PL2`
  - `PL3`
