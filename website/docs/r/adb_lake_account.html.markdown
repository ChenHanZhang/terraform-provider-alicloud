...
* `engine` - (Optional, ForceNew, Computed, Available since v1.270.0) The engine, AnalyticDB.
* `ram_user_list` - (Optional, Computed, List, Available since v1.270.0) RamUsers
