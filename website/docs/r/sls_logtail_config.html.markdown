...
* `create_time` - (Optional, ForceNew, Available since v1.269.0) The creation time of the resource
* `input_detail` - (Optional, ForceNew, Map) The detailed configuration entered by logtail.
...
* `logtail_config_name` - (Optional, ForceNew, Computed, Available since v1.269.0) The name of the resource
* `output_detail` - (Optional, ForceNew, Set, Available since v1.269.0) Detailed configuration of logtail output See [`output_detail`](#output_detail) below.
* `output_type` - (Optional, ForceNew) Log output mode. You can only upload data to log service.
* `project_name` - (Required, ForceNew, Available since v1.269.0) Project name

### `output_detail`

The output_detail supports the following:
* `endpoint` - (Optional, ForceNew, Available since v1.269.0) The endpoint of the log project.
* `logstore_name` - (Optional, ForceNew, Available since v1.269.0) The name of the output target logstore.
* `region` - (Optional, ForceNew, Available since v1.269.0) Region
