...
Credentials used to authenticate associated principals. These credentials are typically long-term, support version management, and require rotation. Examples include passwords for system users and public-private key pairs on Linux hosts.  .
