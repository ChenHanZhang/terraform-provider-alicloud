...
* `ai_template` - (Optional, Computed, Available since v1.272.0) HTTP DDoS Intelligent Protection Level. Values:
  ...
  - `level60`: Normal.
  - `level90`: Strict.
* `automatic_frequency_control_action_type` - (Optional, Available since v1.272.0) Disposal action.Valid values:
  - `observe`: Observe.
  - `deny`: Block.
  - `js`: Js verification.
* `automatic_frequency_control_enable` - (Optional, Available since v1.272.0) Switch.Valid values:
  - `on`: on.
  - `off`: off.
* `automatic_frequency_control_level` - (Optional, Available since v1.272.0) Protection Level.Valid values:
  - `loose`: Loose.
  - `normal`: Normal.
  - `strict`: Strict.
...
* `client_ca_certificate_id` - (Optional, Available since v1.272.0) Client CA certificate ID.
* `client_certificate_hostnames` - (Optional, List, Available since v1.272.0) Client certificate bound domain list.
...
* `paused` - (Optional, Available since v1.266.0) Specifies whether to temporarily pause ESA on the website. If you set this parameter to true, all requests to the domains in your DNS records go directly to your origin server. Valid values:
  - `true`
  - `false`
* `performance_data_collection_enable` - (Optional, Available since v1.272.0) Whether to enable the quality data collection switch.Valid values:
  - `on`: on.
  - `off`: off.
* `real_client_ip_header_name` - (Optional, Available since v1.272.0) Real client IP header name.
...
* `site_waf_settings` - (Optional, Set, Available since v1.272.0) Site WAF Configuration Details. See [`site_waf_settings`](#site_waf_settings) below.
...
* `add_bot_protection_headers` - (Optional, Set, Available since v1.272.0) Add BOT Protection Header. See [`add_bot_protection_headers`](#site_waf_settings-add_bot_protection_headers) below.
* `add_security_headers` - (Optional, Set, Available since v1.272.0) Add Security Header. See [`add_security_headers`](#site_waf_settings-add_security_headers) below.
* `bandwidth_abuse_protection` - (Optional, Set, Available since v1.272.0) Anti-theft brush. See [`bandwidth_abuse_protection`](#site_waf_settings-bandwidth_abuse_protection) below.
* `bot_management` - (Optional, Set, Available since v1.272.0) Bot Management. See [`bot_management`](#site_waf_settings-bot_management) below.
* `client_ip_identifier` - (Optional, Set, Available since v1.272.0) Client IP Identification. See [`client_ip_identifier`](#site_waf_settings-client_ip_identifier) below.
* `security_level` - (Optional, Set, Available since v1.272.0) Security Level. See [`security_level`](#site_waf_settings-security_level) below.

### `site_waf_settings-add_bot_protection_headers`

The site_waf_settings-add_bot_protection_headers supports the following:
* `enable` - (Optional, Available since v1.272.0) Switch.
...
* `action` - (Optional, Available since v1.272.0) Anti-theft brush Rule Action.Valid values:
  - `deny`: Deny.
  - `monitor`: Monitor.
  - `captcha`: Captcha.
* `status` - (Optional, Available since v1.272.0) Anti-theft brush Rule Status.

### `site_waf_settings-bot_management`

The site_waf_settings-bot_management supports the following:
* `definite_bots` - (Optional, Set, Available since v1.272.0) Definitely Bot. See [`definite_bots`](#site_waf_settings-bot_management-definite_bots) below.
* `effect_on_static` - (Optional, Set, Available since v1.272.0) VApply to Static Resource Requests. See [`effect_on_static`](#site_waf_settings-bot_management-effect_on_static) below.
* `js_detection` - (Optional, Set, Available since v1.272.0) JavaScript Challenge. See [`js_detection`](#site_waf_settings-bot_management-js_detection) below.
* `likely_bots` - (Optional, Set, Available since v1.272.0) Likely Bot. See [`likely_bots`](#site_waf_settings-bot_management-likely_bots) below.
* `verified_bots` - (Optional, Set, Available since v1.272.0) Verified Bot. See [`verified_bots`](#site_waf_settings-bot_management-verified_bots) below.

### `site_waf_settings-client_ip_identifier`

The site_waf_settings-client_ip_identifier supports the following:
* `headers` - (Optional, List, Available since v1.272.0) Specify Headers.
* `mode` - (Optional, Available since v1.272.0) Identification Mode.Valid values:
...
* `value` - (Optional, Available since v1.272.0) Security level value. Valid values:
  - `high`: High.
  - `low`: Low.
...
* `action` - (Optional, Available since v1.272.0) Action.Valid values:
  - `allow`: Allow.
  - `deny`: Deny.
  - `monitor`: Monitor.
  - `captcha`: Captcha.
