...
* `original_region_id` - (Required) The ID of the target region. You can view the region ID through the DescribeRegions interface.
...
* `parameter_group_id` - (Required) The ID of the source parameter template. You can view the parameter Template ID by describing parametergroups.
