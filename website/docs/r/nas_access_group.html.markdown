...
* `name` - (Deprecated since v1.269.0). Field 'name' has been deprecated from provider version 1.269.0. New field 'access_group_name' instead.
* `type` - (Deprecated since v1.269.0). Field 'type' has been deprecated from provider version 1.269.0. New field 'access_group_type' instead.
