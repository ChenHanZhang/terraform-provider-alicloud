...
* `ingress_info` - (Optional, Set, Available since v1.284.0) Ingress Info See [`ingress_info`](#ingress_info) below.
...
* `route_backend` - (Optional, ForceNew, Set, Available since v1.284.0) RouteBackend See [`route_backend`](#route_backend) below.
...
* `cluster_id` - (Optional, Available since v1.284.0) Cluster ID
* `ingress_class` - (Optional, Available since v1.284.0) Ingress Class
* `override_ingress_ip` - (Optional, Available since v1.284.0) Override Ingress IP
* `source_id` - (Optional, Available since v1.284.0, Deprecated since v1.284.0) Source ID
* `watch_namespace` - (Optional, Available since v1.284.0) Watch Namespace

### `route_backend`

The route_backend supports the following:
* `services` - (Optional, ForceNew, List, Available since v1.284.0) Services See [`services`](#route_backend-services) below.

### `route_backend-services`

The route_backend-services supports the following:
* `name` - (Optional, ForceNew, Available since v1.284.0) Name
