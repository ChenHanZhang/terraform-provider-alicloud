...
* `gateway_id` - (Optional, ForceNew, Available since v1.275.0) Cloud-native API gateway ID.
* `gateway_type` - (Optional, ForceNew, Available since v1.275.0) Gateway type filter. Currently, `AI` and `API` gateway types are supported.
