...
* `description` - (Optional, Available since v1.281.0) The description of the associated resource. The length must be 0 to 128 characters.
* `ecr_id` - (Required, ForceNew) The ID of the Express Connect router instance.
* `tags` - (Optional, ForceNew, Map, Available since v1.281.0) The list of tags to bind.
...
* `allowed_prefix_history` - The list of historical prefix routes.
  * `allowed_prefix` - The prefix route.
  * `gmt_create` - The time when the historical route entry was created.
