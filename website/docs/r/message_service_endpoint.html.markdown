...
* `cidr_list` - (Optional, List, Available since v1.273.0) The CIDR blocks. See [`cidr_list`](#cidr_list) below.
...
* `acl_strategy` - (Required, Available since v1.273.0) The ACL policy. Valid value:
  - allow: indicates that the current endpoint allows access from the corresponding CIDR block. (Only allow is supported)
* `cidr` - (Required, Available since v1.273.0) The CIDR block.
