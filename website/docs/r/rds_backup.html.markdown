...
-> **NOTE:**  * MariaDB instances support only snapshot backup. However, set this parameter to `Physical`.  
...
* `resource_group_id` - (Optional, ForceNew, Computed, Available since v1.274.0) The ID of the resource group
