...
* `service_linked_role` - (Optional, ForceNew, Computed, Available since v1.286.0) The service-linked role. Default value: `AliyunServiceRoleForSas`. Valid values:
  - `AliyunServiceRoleForSas`: The service-linked role for Security Center (SAS). SAS uses this role to access your resources in other Alibaba Cloud services.
...
* `role_status` - The status of the service-linked role.
