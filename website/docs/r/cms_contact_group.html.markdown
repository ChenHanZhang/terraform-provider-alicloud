...
* `contact_group_id` - (Optional, ForceNew, Computed) The unique identifier of the contact group.
* `contact_group_name` - (Optional) The name of the contact.
* `contact_ids` - (Optional, List) The contact IDs.
