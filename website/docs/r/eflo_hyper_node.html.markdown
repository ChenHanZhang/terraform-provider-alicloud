...
* `cluster_id` - (Optional, Available since v1.266.0) Cluster ID
* `data_disk` - (Optional, List, Available since v1.266.0) List of disk information See [`data_disk`](#data_disk) below.

-> **NOTE:** This parameter only applies during resource update. If modified in isolation without other property changes, Terraform will not trigger any action.

* `hostname` - (Optional, Available since v1.266.0) Host name
* `hpn_zone` - (Optional, ForceNew) Number of the cluster to which the supercompute node belongs
* `login_password` - (Optional, Available since v1.266.0) Login Password
* `machine_type` - (Optional, ForceNew) The model used by the super computing node
* `node_group_id` - (Optional, Available since v1.266.0) Node group ID
...
* `user_data` - (Optional, Available since v1.266.0) Custom Data
* `vswitch_id` - (Optional, Available since v1.266.0) Switch ID
* `vpc_id` - (Optional, Available since v1.266.0) VPC ID
* `zone_id` - (Optional, ForceNew) The zone where the super compute node is located

### `data_disk`

The data_disk supports the following:
* `bursting_enabled` - (Optional, Available since v1.266.0) Whether to enable Burst (performance Burst).
* `category` - (Optional, Available since v1.266.0) The disk type. Value range:
  - cloud_essd:ESSD cloud disk.
* `delete_with_node` - (Optional, Available since v1.266.0) Whether the data disk is unsubscribed and deleted with the node.
* `performance_level` - (Optional, Available since v1.266.0) When creating an ESSD cloud disk to use as a system disk, set the performance level of the cloud disk. Value range:
  - PL0: maximum random read/write IOPS 10000 for a single disk.
  - PL1: maximum random read/write IOPS 50000 for a single disk.
* `provisioned_iops` - (Optional, Int, Available since v1.266.0) ESSD AutoPL cloud disk (single disk) pre-configuration performance of IOPS.
* `size` - (Optional, Int, Available since v1.266.0) The size of the disk. The unit is GiB.
