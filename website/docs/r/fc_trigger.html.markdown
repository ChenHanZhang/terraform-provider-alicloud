...
-> **NOTE:** **Recommendation: For new projects, please consider using FCV3 resources (e.g., `alicloud_fcv3_trigger`) as they provide enhanced capabilities and are actively maintained. The traditional FC resources are maintained for backward compatibility.**
