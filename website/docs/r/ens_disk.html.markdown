...
For information about ENS Disk and how to use it, see [What is Disk](https://www.alibabacloud.com/help/en/).
...
* `payment_type` - (Required, ForceNew) Billing type of the disk instanceValue: PostPaid.
...
* `disk_name` - Name of the disk instance.
