		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					"description":          "ran资源用名称051801twosg",
					...
					"security_group_ids": []string{
						"${alicloud_security_group.secRC_clone_1_clone_0.id}", "${alicloud_security_group.security_group_two.id}"},
...
resource "alicloud_security_group" "security_group_two" {
  security_group_name = "ran_sg_two"
...
func TestAccAliCloudRdsCustom_basic12789(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					"description":          "ran资源用名称052001userdata",
					"user_data":            "IyEvYmluL3NoCmVjaG8gIkhlbGxvIFdvcmxkLiBUaGUgdGltZSBpcyBub3cgJChkYXRlIC1SKSEiIHwgdGVlIC9yb290L3VzZXJkYXRhX3Rlc3QwNDIzdHdvLnR4dA==",
					"instance_charge_type": "PostPaid",
					"auto_renew":           "false",
					"amount":               "1",
					...
					"auto_pay":             "false",
					"security_group_ids": []string{
						"${alicloud_security_group.secRC_clone_1_clone_0_clone_0.id}", "${alicloud_security_group.security_group_two_clone_0.id}"},
					"system_disk": []map[string]interface{}{
						{
							"category":          "cloud_essd",
							"size":              "40",
			...
			},
			{
				Config: testAccConfig(map[string]interface{}{
					"deletion_protection":  "false",
					"auto_pay":             "true",
					"instance_type":        "mysql.xa4.xlarge.8cm",
					"password":             "@MY7yxqc9YXQCUPDATE",
					"status":               "Stopped",
					"reboot_time":          "2026-05-21T05:40Z",
					"direction":            "Up",
					"reboot_when_finished": "false",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						"deletion_protection":  "false",
...
resource "alicloud_security_group" "security_group_two_clone_0" {
  security_group_name = "ran_sg_two"
...
// Case resourceCase_20260415_01_clone_1_clone_0_clone_1 12807
func TestAccAliCloudRdsCustom_basic12807(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_rds_custom.default"
	ra := resourceAttrInit(resourceId, AlicloudRdsCustomMap12807)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
		return &RdsServiceV2{testAccProvider.Meta().(*connectivity.AliyunClient)}
	}, "DescribeRdsCustom")
	rac := resourceAttrCheckInit(rc, ra)
	...
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tfaccrds%d", rand)
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudRdsCustomBasicDependence12807)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					"description":          "ran资源用名称0515单个sg",
					"instance_charge_type": "PostPaid",
					"auto_renew":           "false",
					"amount":               "1",
					"vswitch_id":           "${alicloud_vswitch.vswRC_clone_1_clone_0_clone_1.id}",
					"dry_run":              "false",
					"deletion_protection":  "true",
					"auto_pay":             "true",
					"security_group_ids": []string{
						"${alicloud_security_group.secRC_clone_1_clone_0_clone_1.id}"},
					"system_disk": []map[string]interface{}{
						{
							"category":          "cloud_essd",
							"size":              "40",
...
var AlicloudRdsCustomMap12807 = map[string]string{
	"region_id": CHECKSET,
}

func AlicloudRdsCustomBasicDependence12807(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}

resource "alicloud_vpc" "vpcRC_clone_1_clone_0_clone_1" {
  is_default = false
  cidr_block = "172.16.0.0/16"
  vpc_name   = "ran_vpc1"
}

resource "alicloud_security_group" "secRC_clone_1_clone_0_clone_1" {
  description         = "sg"
  security_group_name = "ran_sg"
  vpc_id              = alicloud_vpc.vpcRC_clone_1_clone_0_clone_1.id
}

resource "alicloud_vswitch" "vswRC_clone_1_clone_0_clone_1" {
  is_default   = false
  vpc_id       = alicloud_vpc.vpcRC_clone_1_clone_0_clone_1.id
  zone_id      = "cn-beijing-i"
  cidr_block   = "172.16.0.0/23"
		...
		Steps: []resource.TestStep{
			...
			},
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"reboot_time":          "2026-05-22CST1313:050528800",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						"instance_type":        "mysql.x2.xlarge.7cm",
