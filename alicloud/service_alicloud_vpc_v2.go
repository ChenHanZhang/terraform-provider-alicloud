...
func (s *VpcServiceV2) DescribeVpcIpv6CidrBlock(id string) (object map[string]interface{}, err error) {
	...
	v, err := jsonpath.Get("$.Vpcs.Vpc[*].Ipv6CidrBlocks.Ipv6CidrBlock[*]", response)
	if err != nil {
		return object, WrapErrorf(err, FailedGetAttributeMsg, id, "$.Vpcs.Vpc[*].Ipv6CidrBlocks.Ipv6CidrBlock[*]", response)
	}
