...
// Case 域名测试_Terraform_02091120_副本1774340240970 12670
func TestAccAliCloudLiveDomain_basic12670(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_live_domain.default"
	ra := resourceAttrInit(resourceId, AlicloudLiveDomainMap12670)
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudLiveDomainBasicDependence12670)
...
var AlicloudLiveDomainMap12670 = map[string]string{
	"create_time": CHECKSET,
}

func AlicloudLiveDomainBasicDependence12670(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
...
variable "domain_name" {
  default = "antang-terraform-domain20260325070703030606"
}
...
// Case 域名测试_Terraform_修改版 12233
func TestAccAliCloudLiveDomain_basic12233(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_live_domain.default"
	ra := resourceAttrInit(resourceId, AlicloudLiveDomainMap12233)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
		return &LiveServiceV2{testAccProvider.Meta().(*connectivity.AliyunClient)}
	}, "DescribeLiveDomain")
	rac := resourceAttrCheckInit(rc, ra)
	...
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tfacclive%d", rand)
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudLiveDomainBasicDependence12233)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
...
var AlicloudLiveDomainMap12233 = map[string]string{
	"create_time": CHECKSET,
}

func AlicloudLiveDomainBasicDependence12233(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
...
variable "domain_name" {
  default = "antang-terraform-domain20260325070703030707"
}
