...
// DescribeSslCertificatesServicePcaCert <<< Encapsulated get interface for SslCertificatesService PcaCert.
...
// SetResourceTags <<< Encapsulated tag function for SslCertificatesService.
func (s *SslCertificatesServiceServiceV2) SetResourceTags(d *schema.ResourceData, resourceType string) error {
	if d.HasChange("tags") {
		var action string
		var err error
