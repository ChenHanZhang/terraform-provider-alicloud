...
func TestAccAlicloudConfigRule_regression(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_config_rule.default"
	ra := resourceAttrInit(resourceId, AlicloudConfigRuleMap3018)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudConfigRuleBasicDependence3018)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"rule_name":                  "tf-cicd-rule-by-root-ak-check",
...
// Case 3018
func TestAccAlicloudConfigRule_basic3018(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_config_rule.default"
	ra := resourceAttrInit(resourceId, AlicloudConfigRuleMap3018)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
...
var AlicloudConfigRuleMap3018 = map[string]string{}

func AlicloudConfigRuleBasicDependence3018(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
