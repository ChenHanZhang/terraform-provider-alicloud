	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"name": {
				...
				Optional:   true,
				Computed:   true,
				Deprecated: "Field 'name' has been deprecated since provider version 1.269.0. New field 'access_group_name' instead.",
				ForceNew:   true,
			},
			"type": {
				Type:       schema.TypeString,
				Optional:   true,
				Computed:   true,
				Deprecated: "Field 'type' has been deprecated since provider version 1.269.0. New field 'access_group_type' instead.",
				ForceNew:   true,
			},
		},
	}
