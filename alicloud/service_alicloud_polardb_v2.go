...
// DescribePolardbEndpoint <<< Encapsulated get interface for Polardb Endpoint.

func (s *PolardbServiceV2) DescribePolardbEndpoint(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *PolardbServiceV2) PolardbEndpointStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.PolardbEndpointStateRefreshFuncWithApi(id, field, failStates, s.DescribePolardbEndpoint)
}

func (s *PolardbServiceV2) PolardbEndpointStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
func (s *PolardbServiceV2) DescribeAsyncPolardbEndpointStateRefreshFunc(d *schema.ResourceData, res map[string]interface{}, field string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := s.DescribeAsyncDescribeDBClusterEndpoints(d, res)
		if err != nil {
			if NotFoundError(err) {
				return object, "", nil
			}
...
// DescribePolardbEndpoint >>> Encapsulated.
// DescribeAsyncDescribeDBClusterEndpoints <<< Encapsulated for Polardb.
func (s *PolardbServiceV2) DescribeAsyncDescribeDBClusterEndpoints(d *schema.ResourceData, res map[string]interface{}) (object map[string]interface{}, err error) {
	client := s.client
	id := d.Id()
	var request map[string]interface{}
	var response map[string]interface{}
...
// DescribeAsyncDescribeDBClusterEndpoints >>> Encapsulated.
