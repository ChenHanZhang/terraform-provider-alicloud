...
// DescribePolardbDbClusterPerformance <<< Encapsulated get interface for Polardb DbClusterPerformance.

func (s *PolardbServiceV2) DescribePolardbDbClusterPerformance(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *PolardbServiceV2) DescribeDbClusterPerformanceDescribeDBClusterPerformance(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *PolardbServiceV2) PolardbDbClusterPerformanceStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.PolardbDbClusterPerformanceStateRefreshFuncWithApi(id, field, failStates, s.DescribePolardbDbClusterPerformance)
}

func (s *PolardbServiceV2) PolardbDbClusterPerformanceStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribePolardbDbClusterPerformance >>> Encapsulated.
