...
// DescribePolardbBackupLog <<< Encapsulated get interface for Polardb BackupLog.

func (s *PolardbServiceV2) DescribePolardbBackupLog(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *PolardbServiceV2) PolardbBackupLogStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.PolardbBackupLogStateRefreshFuncWithApi(id, field, failStates, s.DescribePolardbBackupLog)
}

func (s *PolardbServiceV2) PolardbBackupLogStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribePolardbBackupLog >>> Encapsulated.
