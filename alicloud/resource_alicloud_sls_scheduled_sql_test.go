...
resource "alicloud_log_project" "defaultKIe4KV" {
  description = "terraform-scheduledsql-test-146"
  name        = "terraform-scheduledsql-test-134"
}
...
resource "alicloud_log_project" "defaultKIe4KV" {
  description = "terraform-scheduledsql-test-496"
  name        = "terraform-scheduledsql-test-527"
}
...
resource "alicloud_log_project" "defaultKIe4KV" {
  description = "terraform-scheduledsql-test-725"
  name        = "terraform-scheduledsql-test-884"
}
