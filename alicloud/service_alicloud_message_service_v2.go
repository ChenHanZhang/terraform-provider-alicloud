...
func (s *MessageServiceServiceV2) DescribeMessageServiceAccountLogging(id string) (object map[string]interface{}, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"RESOURCE_NOT_FOUND"}) {
			return object, WrapErrorf(NotFoundErr("AccountLogging", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *MessageServiceServiceV2) MessageServiceAccountLoggingStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.MessageServiceAccountLoggingStateRefreshFuncWithApi(id, field, failStates, s.DescribeMessageServiceAccountLogging)
}

func (s *MessageServiceServiceV2) MessageServiceAccountLoggingStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
