...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_oos_inventory_entries":                            dataSourceAlicloudOosInventoryEntries(),
			"alicloud_oos_inventory_schema":                             dataSourceAlicloudOosInventorySchema(),
			"alicloud_oos_inventory_search":                             dataSourceAlicloudOosInventorySearch(),
