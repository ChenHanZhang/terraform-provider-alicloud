...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			"alicloud_adb_aps_table_service_optimization":                   resourceAliCloudAdbApsTableServiceOptimization(),
			"alicloud_adb_aps_table_service_lifecycle":                      resourceAliCloudAdbApsTableServiceLifecycle(),
