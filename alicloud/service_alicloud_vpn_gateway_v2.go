...
// DescribeVpnGatewaySslVpnClientCert <<< Encapsulated get interface for VpnGateway SslVpnClientCert.

func (s *VPNGatewayServiceV2) DescribeVpnGatewaySslVpnClientCert(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"InvalidSslVpnClientCertId.NotFound"}) {
			return object, WrapErrorf(NotFoundErr("SslVpnClientCert", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *VPNGatewayServiceV2) VpnGatewaySslVpnClientCertStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.VpnGatewaySslVpnClientCertStateRefreshFuncWithApi(id, field, failStates, s.DescribeVpnGatewaySslVpnClientCert)
}

func (s *VPNGatewayServiceV2) VpnGatewaySslVpnClientCertStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeVpnGatewaySslVpnClientCert >>> Encapsulated.
