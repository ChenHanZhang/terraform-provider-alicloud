...
// DescribeCloudFirewallAddressBook <<< Encapsulated get interface for CloudFirewall AddressBook.

func (s *CloudFirewallServiceV2) DescribeCloudFirewallAddressBook(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	currentStatus := v.([]interface{})[0].(map[string]interface{})["GroupUuid"]
	if currentStatus == nil {
		return object, WrapErrorf(NotFoundErr("AddressBook", id), NotFoundMsg, response)
	}
...
func (s *CloudFirewallServiceV2) CloudFirewallAddressBookStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.CloudFirewallAddressBookStateRefreshFuncWithApi(id, field, failStates, s.DescribeCloudFirewallAddressBook)
}

func (s *CloudFirewallServiceV2) CloudFirewallAddressBookStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeCloudFirewallAddressBook >>> Encapsulated.
