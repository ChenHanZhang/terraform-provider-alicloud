...
// DescribeMongodbBackup <<< Encapsulated get interface for Mongodb Backup.

func (s *MongodbServiceV2) DescribeMongodbBackup(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	addDebug(action, response, request)
	if err != nil {
		if IsExpectedErrors(err, []string{"InvalidBackupSet.NotMatched"}) {
	...
	if err != nil {
		return object, WrapErrorf(err, FailedGetAttributeMsg, id, "$.Backups.Backup[*]", response)
	}
...
func (s *MongodbServiceV2) MongodbBackupStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.MongodbBackupStateRefreshFuncWithApi(id, field, failStates, s.DescribeMongodbBackup)
}

func (s *MongodbServiceV2) MongodbBackupStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
func (s *MongodbServiceV2) DescribeAsyncMongodbBackupStateRefreshFunc(d *schema.ResourceData, res map[string]interface{}, field string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
...
// DescribeMongodbBackup >>> Encapsulated.
// DescribeAsyncDescribeBackups <<< Encapsulated for Mongodb.
func (s *MongodbServiceV2) DescribeAsyncDescribeBackups(d *schema.ResourceData, res map[string]interface{}) (object map[string]interface{}, err error) {
	client := s.client
	id := d.Id()
	var request map[string]interface{}
	var response map[string]interface{}
	...
	request = make(map[string]interface{})
	query = make(map[string]interface{})
	query["BackupJobId"], err = jsonpath.Get("$.BackupJobId", res)
	request["DBInstanceId"] = parts[0]
	request["RegionId"] = client.RegionId
	action := "DescribeBackups"
