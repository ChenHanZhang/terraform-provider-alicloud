...
// DescribeMongodbGlobalSecurityIpGroup <<< Encapsulated get interface for Mongodb GlobalSecurityIpGroup.
...
func (s *MongodbServiceV2) MongodbGlobalSecurityIpGroupStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.MongodbGlobalSecurityIpGroupStateRefreshFuncWithApi(id, field, failStates, s.DescribeMongodbGlobalSecurityIpGroup)
}

func (s *MongodbServiceV2) MongodbGlobalSecurityIpGroupStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
