...
// DescribeMongodbAuditLogFilter <<< Encapsulated get interface for Mongodb AuditLogFilter.

func (s *MongodbServiceV2) DescribeMongodbAuditLogFilter(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *MongodbServiceV2) MongodbAuditLogFilterStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.MongodbAuditLogFilterStateRefreshFuncWithApi(id, field, failStates, s.DescribeMongodbAuditLogFilter)
}

func (s *MongodbServiceV2) MongodbAuditLogFilterStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeMongodbAuditLogFilter >>> Encapsulated.
