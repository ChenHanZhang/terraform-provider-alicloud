...
func resourceAliCloudThreatDetectionServiceLinkedRoleDelete(d *schema.ResourceData, meta interface{}) error {
	...
	threatDetectionServiceV2 := ThreatDetectionServiceV2{client}
	stateConf := BuildStateConf([]string{}, []string{""}, d.Timeout(schema.TimeoutDelete), 10*time.Second, threatDetectionServiceV2.DescribeAsyncThreatDetectionServiceLinkedRoleStateRefreshFunc(d, response, "$.RoleStatus", []string{}))
