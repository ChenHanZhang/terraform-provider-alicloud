...
// Case 删除策略force默认值设置为true 12616
func TestAccAliCloudCenTrafficMarkingPolicy_basic12616(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cen_traffic_marking_policy.default"
	ra := resourceAttrInit(resourceId, AlicloudCenTrafficMarkingPolicyMap12616)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudCenTrafficMarkingPolicyBasicDependence12616)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
...
var AlicloudCenTrafficMarkingPolicyMap12616 = map[string]string{
	"status":                    CHECKSET,
	"traffic_marking_policy_id": CHECKSET,
}

func AlicloudCenTrafficMarkingPolicyBasicDependence12616(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
