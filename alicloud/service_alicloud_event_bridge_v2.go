...
// DescribeEventBridgeNamespace <<< Encapsulated get interface for EventBridge Namespace.

func (s *EventBridgeServiceV2) DescribeEventBridgeNamespace(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	if InArray(fmt.Sprint(code), []string{"NameSpaceNotExist"}) {
...
func (s *EventBridgeServiceV2) EventBridgeNamespaceStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.EventBridgeNamespaceStateRefreshFuncWithApi(id, field, failStates, s.DescribeEventBridgeNamespace)
}

func (s *EventBridgeServiceV2) EventBridgeNamespaceStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeEventBridgeNamespace >>> Encapsulated.
