...
// DescribeEventBridgeConnection <<< Encapsulated get interface for EventBridge Connection.
...
func (s *EventBridgeServiceV2) EventBridgeConnectionStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.EventBridgeConnectionStateRefreshFuncWithApi(id, field, failStates, s.DescribeEventBridgeConnection)
}

func (s *EventBridgeServiceV2) EventBridgeConnectionStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeEventBridgeConnection >>> Encapsulated.
