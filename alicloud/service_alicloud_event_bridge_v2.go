...
// DescribeEventBridgeAgent <<< Encapsulated get interface for EventBridge Agent.

func (s *EventBridgeServiceV2) DescribeEventBridgeAgent(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *EventBridgeServiceV2) EventBridgeAgentStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.EventBridgeAgentStateRefreshFuncWithApi(id, field, failStates, s.DescribeEventBridgeAgent)
}

func (s *EventBridgeServiceV2) EventBridgeAgentStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeEventBridgeAgent >>> Encapsulated.
