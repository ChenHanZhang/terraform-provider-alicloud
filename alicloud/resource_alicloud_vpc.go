	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"ipv6_cidr_block": {
				...
				Computed:   true,
				ForceNew:   true,
				Deprecated: "Field 'ipv6_cidr_block' has been deprecated from provider version 1.282.0. The IPv6 CIDR block of the default VPC.> When **EnableIpv6** is set to **true**, this parameter is required.",
			},
			"ipv6_cidr_blocks": {
			...
			"router_table_id": {
				...
				Optional:   true,
				Computed:   true,
				Deprecated: "Field 'router_table_id' has been deprecated since provider version 1.282.0. New field 'route_table_id' instead.",
				ForceNew:   true,
			},
		},
	}
