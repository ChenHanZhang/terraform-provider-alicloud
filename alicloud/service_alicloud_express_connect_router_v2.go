...
// DescribeExpressConnectRouterRouteMapAssociation <<< Encapsulated get interface for ExpressConnectRouter RouteMapAssociation.

func (s *ExpressConnectRouterServiceV2) DescribeExpressConnectRouterRouteMapAssociation(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	action := "ListRouteMapAssociations"
	request["ClientToken"] = buildClientToken(action)
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ResourceNotFound.AssociationId"}) {
			return object, WrapErrorf(NotFoundErr("RouteMapAssociation", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}

	v, err := jsonpath.Get("$.RouteMapAssociationList[*]", response)
	if err != nil {
		return object, WrapErrorf(err, FailedGetAttributeMsg, id, "$.RouteMapAssociationList[*]", response)
	}
...
func (s *ExpressConnectRouterServiceV2) ExpressConnectRouterRouteMapAssociationStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.ExpressConnectRouterRouteMapAssociationStateRefreshFuncWithApi(id, field, failStates, s.DescribeExpressConnectRouterRouteMapAssociation)
}

func (s *ExpressConnectRouterServiceV2) ExpressConnectRouterRouteMapAssociationStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeExpressConnectRouterRouteMapAssociation >>> Encapsulated.
