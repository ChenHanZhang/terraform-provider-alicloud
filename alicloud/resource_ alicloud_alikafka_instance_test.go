...
variable "实例名" {
  default = "刘江-后付费自动创建TopicGroup-预发927"
}
...
variable "实例名" {
  default = "刘江-创建confluent实例覆盖属性-预发70"
}
...
variable "实例名" {
  default = "刘江-后付费自动创建TopicGroup-预发824"
}
...
variable "实例名" {
  default = "刘江-后付费自动创建TopicGroup-预发880"
}
