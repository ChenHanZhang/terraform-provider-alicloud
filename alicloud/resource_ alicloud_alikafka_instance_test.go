...
variable "实例名" {
  default = "刘江-后付费自动创建TopicGroup-预发991"
}
...
variable "实例名" {
  default = "刘江-创建confluent实例覆盖属性-预发635"
}
...
variable "实例名" {
  default = "刘江-后付费自动创建TopicGroup-预发380"
}
...
variable "实例名" {
  default = "刘江-后付费自动创建TopicGroup-预发837"
}
