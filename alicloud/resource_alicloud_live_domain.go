		...
		liveServiceV2 := LiveServiceV2{client}
				...
				return nil
					...
					return WrapError(err)
                                        ...
                                        d.Set("create_time", objectRaw["GmtCreated"])
                                            ...
                                            d.Set("domain_name", objectRaw["DomainName"])
																						...
																						objectRaw, err = liveServiceV2.DescribeDomainDescribeLiveTagResources(d.Id())
					...
					return WrapError(err)
                                        ...
                                        d.Set("domain_name", objectRaw["ResourceId"])
                
                                                                                    tagsMaps := objectRaw["Tag"]
...
func resourceAliCloudLiveDomainDelete(d *schema.ResourceData, meta interface{}) error {
    ...
    if err != nil {
        ...
        return WrapErrorf(err, DefaultErrorMsg, d.Id(), action, AlibabaCloudSdkGoERROR)
                ...
                liveServiceV2 := LiveServiceV2{client}
        stateConf := BuildStateConf([]string{}, []string{""}, d.Timeout(schema.TimeoutDelete),  0 ,liveServiceV2.DescribeAsyncLiveDomainStateRefreshFunc(d, response, "$.Domains.PageData[*].DomainName", []string {}))
