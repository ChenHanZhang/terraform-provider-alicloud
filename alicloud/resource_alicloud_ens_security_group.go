...
func resourceAliCloudEnsSecurityGroupCreate(d *schema.ResourceData, meta interface{}) error {
	...
	stateConf := BuildStateConf([]string{}, []string{fmt.Sprint(d.Get("security_group_id"))}, d.Timeout(schema.TimeoutCreate), 30*time.Second, ensServiceV2.EnsSecurityGroupStateRefreshFunc(d.Id(), "SecurityGroupId", []string{}))
