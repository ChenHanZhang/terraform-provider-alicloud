	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"operation_system": {
				...
				Required:     true,
				ForceNew:     true,
				ValidateFunc: StringInSlice([]string{"Windows", "CentOS", "AliyunLinux", "Ubuntu", "Debian", "Fedora", "Suse", "RockyLinux", "RedhatEnterpriseLinux", "Anolis"}, false),
			},
			"patch_baseline_name": {
				Type:     schema.TypeString,
				Required: true,
...
func resourceAliCloudOosPatchBaselineRead(d *schema.ResourceData, meta interface{}) error {
	...
	d.Set("approval_rules", objectRaw["ApprovalRules"])
