...
// DescribeEsaErrorPagesRedirectRule <<< Encapsulated get interface for Esa ErrorPagesRedirectRule.

func (s *EsaServiceV2) DescribeEsaErrorPagesRedirectRule(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	action := "GetErrorPagesRedirectRule"
...
func (s *EsaServiceV2) EsaErrorPagesRedirectRuleStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.EsaErrorPagesRedirectRuleStateRefreshFuncWithApi(id, field, failStates, s.DescribeEsaErrorPagesRedirectRule)
}

func (s *EsaServiceV2) EsaErrorPagesRedirectRuleStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeEsaErrorPagesRedirectRule >>> Encapsulated.
