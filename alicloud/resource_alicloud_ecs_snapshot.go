...
func resourceAliCloudEcsSnapshot() *schema.Resource {
  return &schema.Resource{
    ...
    Timeouts: &schema.ResourceTimeout{
            ...
            Type:schema.TypeBool,
                                                                                            Optional: true,
                                                                                    Deprecated: "Field 'instant_access' has been deprecated from provider version 1.272.0. Field `instant_access` has been deprecated from provider version 1.231.0.",
                                                                                                                                                },
                                    "instant_access_retention_days": {
            Type:schema.TypeInt,
                                                                                            Optional: true,
                                                                        ForceNew: true,
                                        Deprecated: "Field 'instant_access_retention_days' has been deprecated from provider version 1.272.0. Field `instant_access_retention_days` has been deprecated from provider version 1.231.0.",
                                                                                                                                                },
                                    "kms_key_id": {
            Type:schema.TypeString,
                                                                                            Optional: true,
            ...
            Type:schema.TypeInt,
                                                                                            Optional: true,
                                                                                                                                                ValidateFunc: IntBetween(0, 36500),
                                                                                    },
                                            "lock_mode": {
            Type:schema.TypeString,
                                                                                            Optional: true,
            ...
            Type:schema.TypeString,
                                                                                            Optional: true,
                                                                                                                                                ValidateFunc: StringInSlice([]string{"compliance-cooloff","compliance","expired","unlocked"}, false),
                                                                                    },
                                                                "region_id": {
            Type:schema.TypeString,
                                                                                                            Computed: true,
...
func resourceAliCloudEcsSnapshotCreate(d *schema.ResourceData, meta interface{}) error {
                                                                 ...
                                                                 if v, ok := d.GetOk("disk_id"); ok && fmt.Sprint(v) != "" {
                                                invalidCreate := false
                            if _, ok := d.GetOk("source_snapshot_id"); ok {
                    invalidCreate = true
                }
                        if ! invalidCreate {
    ...
    if err != nil {
        ...
        if _, err := stateConf.WaitForState(); err != nil {
            return WrapErrorf(err, IdMsg, d.Id())
                                                                                                                     ...
                                                                                                                     if v, ok := d.GetOk("source_snapshot_id"); ok && fmt.Sprint(v) != "" {
                                                invalidCreate := false
				...
				return nil
					...
					return WrapError(err)
                                        ...
                                        d.Set("category", objectRaw["Category"])
                                            ...
                                            d.Set("source_snapshot_id", objectRaw["SourceSnapshotId"])
                ...
                d.Set("tags", tagsToMap(tagsMaps))
					...
					return WrapError(err)
                                        ...
                                        d.Set("cool_off_period", objectRaw["CoolOffPeriod"])
                                            ...
                                            d.Set("lock_status", convertEcsSnapshotLockedSnapshotsInfoLockStatusResponse(objectRaw["LockStatus"]))
