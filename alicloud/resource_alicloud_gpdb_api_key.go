...
func resourceAliCloudGpdbApiKey() *schema.Resource {
	return &schema.Resource{
		...
		Update: resourceAliCloudGpdbApiKeyUpdate,
...
func resourceAliCloudGpdbApiKeyUpdate(d *schema.ResourceData, meta interface{}) error {
	log.Printf("[INFO] Cannot update resource Alicloud Resource Api Key.")
	return nil
}
