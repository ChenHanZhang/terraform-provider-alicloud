...
func (s *OssServiceV2) OssBucketAccessMonitorStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.OssBucketAccessMonitorStateRefreshFuncWithApi(id, field, failStates, s.DescribeOssBucketAccessMonitor)
}

func (s *OssServiceV2) OssBucketAccessMonitorStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
