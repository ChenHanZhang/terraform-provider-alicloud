...
func (s *OssServiceV2) DescribeOssAccountPublicAccessBlock(id string) (object map[string]interface{}, err error) {
	...
	currentStatus := v.(map[string]interface{})["BlockPublicAccess"]
...
func (s *OssServiceV2) OssAccountPublicAccessBlockStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.OssAccountPublicAccessBlockStateRefreshFuncWithApi(id, field, failStates, s.DescribeOssAccountPublicAccessBlock)
}

func (s *OssServiceV2) OssAccountPublicAccessBlockStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
