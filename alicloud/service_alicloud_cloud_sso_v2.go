...
// DescribeCloudSsoGroup <<< Encapsulated get interface for CloudSso Group.

func (s *CloudSSOServiceV2) DescribeCloudSsoGroup(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *CloudSSOServiceV2) CloudSsoGroupStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.CloudSsoGroupStateRefreshFuncWithApi(id, field, failStates, s.DescribeCloudSsoGroup)
}

func (s *CloudSSOServiceV2) CloudSsoGroupStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeCloudSsoGroup >>> Encapsulated.
