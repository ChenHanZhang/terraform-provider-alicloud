...
// Case resourceCase_20260703_kjwv8G_clone_0 13000
func TestAccAliCloudCloudFirewallInstance_basic13000(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cloud_firewall_instance.default"
	ra := resourceAttrInit(resourceId, AlicloudCloudFirewallInstanceMap13000)
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudCloudFirewallInstanceBasicDependence13000)
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"cfw_elastic_traffic", "cfw_endpoint", "cfw_ndlp_enable", "modify_type", "period"},
			},
		},
	})
}

var AlicloudCloudFirewallInstanceMap13000 = map[string]string{
	"end_time":     CHECKSET,
...
func AlicloudCloudFirewallInstanceBasicDependence13000(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
...
// Case resourceCase_20260709_zx5fT4_clone_0 13001
func TestAccAliCloudCloudFirewallInstance_basic13001(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cloud_firewall_instance.default"
	ra := resourceAttrInit(resourceId, AlicloudCloudFirewallInstanceMap13001)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
		return &CloudFirewallServiceV2{testAccProvider.Meta().(*connectivity.AliyunClient)}
	}, "DescribeCloudFirewallInstance")
	rac := resourceAttrCheckInit(rc, ra)
	...
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tfacccloudfirewall%d", rand)
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudCloudFirewallInstanceBasicDependence13001)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
...
var AlicloudCloudFirewallInstanceMap13001 = map[string]string{
	"end_time":     CHECKSET,
	"user_status":  CHECKSET,
	"status":       CHECKSET,
	"create_time":  CHECKSET,
...
func AlicloudCloudFirewallInstanceBasicDependence13001(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
...
// Case resourceCase_20260703_kjwv8G 13002
func TestAccAliCloudCloudFirewallInstance_basic13002(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cloud_firewall_instance.default"
	ra := resourceAttrInit(resourceId, AlicloudCloudFirewallInstanceMap13002)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
		return &CloudFirewallServiceV2{testAccProvider.Meta().(*connectivity.AliyunClient)}
	}, "DescribeCloudFirewallInstance")
	rac := resourceAttrCheckInit(rc, ra)
	...
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tfacccloudfirewall%d", rand)
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudCloudFirewallInstanceBasicDependence13002)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
...
var AlicloudCloudFirewallInstanceMap13002 = map[string]string{
	"end_time":     CHECKSET,
	"user_status":  CHECKSET,
	"status":       CHECKSET,
	"create_time":  CHECKSET,
...
func AlicloudCloudFirewallInstanceBasicDependence13002(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
...
// Case resourceCase_20260709_zx5fT4_clone_0_clone_0 13003
func TestAccAliCloudCloudFirewallInstance_basic13003(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cloud_firewall_instance.default"
	ra := resourceAttrInit(resourceId, AlicloudCloudFirewallInstanceMap13003)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
		return &CloudFirewallServiceV2{testAccProvider.Meta().(*connectivity.AliyunClient)}
	}, "DescribeCloudFirewallInstance")
	rac := resourceAttrCheckInit(rc, ra)
	...
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tfacccloudfirewall%d", rand)
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudCloudFirewallInstanceBasicDependence13003)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
...
var AlicloudCloudFirewallInstanceMap13003 = map[string]string{
	"end_time":     CHECKSET,
	"user_status":  CHECKSET,
	"status":       CHECKSET,
	"create_time":  CHECKSET,
...
func AlicloudCloudFirewallInstanceBasicDependence13003(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
...
// Case resourceCase_20260709_zx5fT4 12999
func TestAccAliCloudCloudFirewallInstance_basic12999(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cloud_firewall_instance.default"
	ra := resourceAttrInit(resourceId, AlicloudCloudFirewallInstanceMap12999)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
		return &CloudFirewallServiceV2{testAccProvider.Meta().(*connectivity.AliyunClient)}
	}, "DescribeCloudFirewallInstance")
	rac := resourceAttrCheckInit(rc, ra)
	...
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tfacccloudfirewall%d", rand)
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudCloudFirewallInstanceBasicDependence12999)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
...
var AlicloudCloudFirewallInstanceMap12999 = map[string]string{
	"end_time":     CHECKSET,
	"user_status":  CHECKSET,
	"status":       CHECKSET,
	"create_time":  CHECKSET,
...
func AlicloudCloudFirewallInstanceBasicDependence12999(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
