...
resource "alicloud_hbr_vault" "defaultyk84Hc" {
  vault_type = "STANDARD"
  vault_name = "vault-example-1785738192"
}

resource "alicloud_hbr_policy" "defaultoqWvHQ" {
  policy_name = "terraform-test-时间引用：GetCurrentUnixTimeStamp(0,'ms','s')-683"
  rules {
    rule_type    = "BACKUP"
...
resource "alicloud_hbr_vault" "defaultQNFISO" {
  vault_type = "STANDARD"
  vault_name = "vault-example-1785738195"
}

resource "alicloud_hbr_policy" "defaultoqWvHQ" {
  policy_name = "policy-example-1785738195"
  rules {
    rule_type    = "BACKUP"
    backup_type  = "COMPLETE"
