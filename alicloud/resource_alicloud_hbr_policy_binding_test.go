...
resource "alicloud_hbr_vault" "defaultyk84Hc" {
  vault_type = "STANDARD"
  vault_name = "vault-example-1785738502"
}

resource "alicloud_hbr_policy" "defaultoqWvHQ" {
  policy_name = "terraform-test-时间引用：GetCurrentUnixTimeStamp(0,'ms','s')-107"
  rules {
    rule_type    = "BACKUP"
...
resource "alicloud_hbr_vault" "defaultQNFISO" {
  vault_type = "STANDARD"
  vault_name = "vault-example-1785738504"
}

resource "alicloud_hbr_policy" "defaultoqWvHQ" {
  policy_name = "policy-example-1785738504"
  rules {
    rule_type    = "BACKUP"
    backup_type  = "COMPLETE"
