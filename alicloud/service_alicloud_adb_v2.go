...
// DescribeAdbDbClusterLakeVersion <<< Encapsulated get interface for Adb DbClusterLakeVersion.

func (s *AdbServiceV2) DescribeAdbDbClusterLakeVersion(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *AdbServiceV2) DescribeDbClusterLakeVersionDescribeAuditLogConfig(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	addDebug(action, response, request)
	if err != nil {
		if IsExpectedErrors(err, []string{"404", "400"}) {
			return object, WrapErrorf(NotFoundErr("DbClusterLakeVersion", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *AdbServiceV2) DescribeDbClusterLakeVersionDescribeEssdCacheConfig(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *AdbServiceV2) DescribeDbClusterLakeVersionDescribeLakeCacheSize(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *AdbServiceV2) DescribeDbClusterLakeVersionDescribeDBClusterSSL(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *AdbServiceV2) DescribeDbClusterLakeVersionDescribeClusterAccessWhiteList(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *AdbServiceV2) DescribeDbClusterLakeVersionDescribeCompactionServiceSwitch(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *AdbServiceV2) AdbDbClusterLakeVersionStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.AdbDbClusterLakeVersionStateRefreshFuncWithApi(id, field, failStates, s.DescribeAdbDbClusterLakeVersion)
}

func (s *AdbServiceV2) AdbDbClusterLakeVersionStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
		...
		object["PayType"] = convertAdbDbClusterLakeVersionItemsDBClusterPayTypeResponse(object["PayType"])
		v, err := jsonpath.Get(field, object)
		currentStatus := fmt.Sprint(v)
...
// DescribeAdbDbClusterLakeVersion >>> Encapsulated.
// SetResourceTags <<< Encapsulated tag function for Adb.
func (s *AdbServiceV2) SetResourceTags(d *schema.ResourceData, resourceType string) error {
	if d.HasChange("tags") {
		var action string
		var err error
		client := s.client
