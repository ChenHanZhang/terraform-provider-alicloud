...
// DescribeAdbApsTableServiceLifecycle <<< Encapsulated get interface for Adb ApsTableServiceLifecycle.

func (s *AdbServiceV2) DescribeAdbApsTableServiceLifecycle(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	action := "DescribeApsLifecycleStrategy"
	conn, err := client.NewAdbClient()
	if err != nil {
		return object, WrapError(err)
	}
	...
	if err != nil {
		return object, WrapErrorf(Error(GetNotFoundMessage("ApsTableServiceLifecycle", id)), NotFoundMsg, response)
	}

	return v.(map[string]interface{}), nil
}

func (s *AdbServiceV2) AdbApsTableServiceLifecycleStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := s.DescribeAdbApsTableServiceLifecycle(id)
		if err != nil {
			if NotFoundError(err) {
				return object, "", nil
			}
...
// DescribeAdbApsTableServiceLifecycle >>> Encapsulated.

// DescribeAdbApsTableServiceOptimization <<< Encapsulated get interface for Adb ApsTableServiceOptimization.

func (s *AdbServiceV2) DescribeAdbApsTableServiceOptimization(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	action := "DescribeApsOptimizationStrategy"
	conn, err := client.NewAdbClient()
	if err != nil {
		return object, WrapError(err)
	}
...
func (s *AdbServiceV2) AdbApsTableServiceOptimizationStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := s.DescribeAdbApsTableServiceOptimization(id)
		if err != nil {
			if NotFoundError(err) {
				return object, "", nil
			}
...
// DescribeAdbApsTableServiceOptimization >>> Encapsulated.
