...
func TestAccAliCloudCloudFirewallAddressBook_basic5031(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"group_name":  "IPv4AddressBookUpdate1235",
					"description": "AddressBook update by Terraform",
					"address_list": []string{
						"1.1.1.1/32", "2.2.2.2/32"},
				}),
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"group_name":   "IPv4AddressBookUpdate2892",
					"address_list": []string{},
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
...
func TestAccAliCloudCloudFirewallAddressBook_basic5139(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					"group_name":       "ECSTagAddressBook709",
					"description":      "AddressBook create by Terraform",
					"lang":             "zh",
					"address_list":     []string{},
					"group_type":       "tag",
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"group_name":       "ECSTagAddressBookUpdate1284",
					"description":      "AddressBook update by Terraform",
					"auto_add_tag_ecs": "1",
					"tag_relation":     "or",
				}),
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"group_name": "ECSTagAddressBookUpdate2870",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						"group_name": CHECKSET,
...
func TestAccAliCloudCloudFirewallAddressBook_basic5038(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"group_name":  "IPv6AddressBookUpdate1408",
					"description": "AddressBook update by Terraform",
					"address_list": []string{
						"1::/128", "2::/128"},
				}),
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"group_name":   "IPv6AddressBookUpdate2154",
					"address_list": []string{},
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
...
func TestAccAliCloudCloudFirewallAddressBook_basic5155(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					"group_name":  "DomainAddressBook227",
					"description": "AddressBook create by Terraform",
					"lang":        "zh",
					"address_list": []string{
						"1.com", "2.com", "3.com", "4.com"},
