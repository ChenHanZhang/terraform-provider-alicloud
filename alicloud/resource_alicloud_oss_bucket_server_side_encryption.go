...
func resourceAliCloudOssBucketServerSideEncryptionCreate(d *schema.ResourceData, meta interface{}) error {
        ...
        request = make(map[string]interface{})
                hostMap["bucket"] = StringPointer(d.Get("bucket").(string))
                                                                                                                    ...
                                                                                                                    serverSideEncryptionRule := make(map[string]interface{})

                                                                            if v := d.Get("sse_algorithm");  !IsNil(v)   {
                                                                                    applyServerSideEncryptionByDefault := make(map[string]interface{})
                                        applyServerSideEncryptionByDefault["SSEAlgorithm"] = v                                                            applyServerSideEncryptionByDefault["KMSMasterKeyID"] = v                                                            applyServerSideEncryptionByDefault["KMSDataEncryption"] = v                    
            if len(applyServerSideEncryptionByDefault) > 0 {
        serverSideEncryptionRule["ApplyServerSideEncryptionByDefault"] = applyServerSideEncryptionByDefault
        }
                                                        }
                            
            request["ServerSideEncryptionRule"] = serverSideEncryptionRule
    ...
    request = make(map[string]interface{})
            ...
            update = true
                                                ...
                                                if v := d.Get("sse_algorithm");  !IsNil(v)  || d.HasChange("sse_algorithm")  {
                                                                                    applyServerSideEncryptionByDefault := make(map[string]interface{})
