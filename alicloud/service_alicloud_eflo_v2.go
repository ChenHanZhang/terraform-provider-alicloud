...
// DescribeEfloErRouteMap <<< Encapsulated get interface for Eflo ErRouteMap.

func (s *EfloServiceV2) DescribeEfloErRouteMap(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"1003"}) {
			return object, WrapErrorf(NotFoundErr("ErRouteMap", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *EfloServiceV2) EfloErRouteMapStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.EfloErRouteMapStateRefreshFuncWithApi(id, field, failStates, s.DescribeEfloErRouteMap)
}

func (s *EfloServiceV2) EfloErRouteMapStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeEfloErRouteMap >>> Encapsulated.
