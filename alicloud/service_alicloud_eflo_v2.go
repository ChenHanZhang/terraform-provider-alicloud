...
// DescribeEfloErAttachment <<< Encapsulated get interface for Eflo ErAttachment.

func (s *EfloServiceV2) DescribeEfloErAttachment(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"1003"}) {
			return object, WrapErrorf(NotFoundErr("ErAttachment", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *EfloServiceV2) EfloErAttachmentStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.EfloErAttachmentStateRefreshFuncWithApi(id, field, failStates, s.DescribeEfloErAttachment)
}

func (s *EfloServiceV2) EfloErAttachmentStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeEfloErAttachment >>> Encapsulated.
