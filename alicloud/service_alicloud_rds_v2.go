...
// DescribeRdsCustomSnapshot <<< Encapsulated get interface for Rds CustomSnapshot.

func (s *RdsServiceV2) DescribeRdsCustomSnapshot(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	if len(v.([]interface{})) == 0 {
		return object, WrapErrorf(NotFoundErr("CustomSnapshot", id), NotFoundMsg, response)
	}

	return v.([]interface{})[0].(map[string]interface{}), nil
}
func (s *RdsServiceV2) DescribeCustomSnapshotListTagResources(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *RdsServiceV2) RdsCustomSnapshotStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.RdsCustomSnapshotStateRefreshFuncWithApi(id, field, failStates, s.DescribeRdsCustomSnapshot)
}

func (s *RdsServiceV2) RdsCustomSnapshotStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeRdsCustomSnapshot >>> Encapsulated.
