...
// DescribeRdsDbProxy <<< Encapsulated get interface for Rds DbProxy.

func (s *RdsServiceV2) DescribeRdsDbProxy(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	currentStatus := response["DBProxyInstanceStatus"]
	if currentStatus == nil {
		return object, WrapErrorf(NotFoundErr("DbProxy", id), NotFoundMsg, response)
	}

	return response, nil
}
func (s *RdsServiceV2) DescribeDbProxyDescribeDBProxyEndpoint(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	addDebug(action, response, request)
	if err != nil {
		if IsExpectedErrors(err, []string{"Maxscale.NotFound"}) {
			return object, WrapErrorf(NotFoundErr("DbProxy", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *RdsServiceV2) RdsDbProxyStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.RdsDbProxyStateRefreshFuncWithApi(id, field, failStates, s.DescribeRdsDbProxy)
}

func (s *RdsServiceV2) RdsDbProxyStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
		...
		object["DBProxyInstanceType"] = convertRdsDbProxyDBProxyInstanceTypeResponse(object["DBProxyInstanceType"])
		v, err := jsonpath.Get(field, object)
		currentStatus := fmt.Sprint(v)
...
// DescribeRdsDbProxy >>> Encapsulated.
