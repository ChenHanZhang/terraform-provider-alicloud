...
// DescribeRdsDedicatedHost <<< Encapsulated get interface for Rds DedicatedHost.

func (s *RdsServiceV2) DescribeRdsDedicatedHost(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *RdsServiceV2) RdsDedicatedHostStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.RdsDedicatedHostStateRefreshFuncWithApi(id, field, failStates, s.DescribeRdsDedicatedHost)
}

func (s *RdsServiceV2) RdsDedicatedHostStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeRdsDedicatedHost >>> Encapsulated.
