...
func (s *RdsServiceV2) DescribeAsyncRdsBackupStateRefreshFunc(d *schema.ResourceData, res map[string]interface{}, field string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := s.DescribeAsyncDescribeBackupTasks(d, res)
		if err != nil {
			if NotFoundError(err) {
				return object, "", nil
			}
...
// DescribeAsyncDescribeBackupTasks <<< Encapsulated for Rds.
func (s *RdsServiceV2) DescribeAsyncDescribeBackupTasks(d *schema.ResourceData, res map[string]interface{}) (object map[string]interface{}, err error) {
	client := s.client
	id := d.Id()
	var request map[string]interface{}
	var response map[string]interface{}
...
// DescribeAsyncDescribeBackupTasks >>> Encapsulated.
