...
// DescribeCloudMonitorServiceEventRule <<< Encapsulated get interface for CloudMonitorService EventRule.

func (s *CloudMonitorServiceServiceV2) DescribeCloudMonitorServiceEventRule(id string) (object map[string]interface{}, err error) {
	...
	err = resource.Retry(1*time.Minute, func() *resource.RetryError {
		response, err = conn.DoRequest(StringPointer(action), nil, StringPointer("POST"), StringPointer("2019-01-01"), StringPointer("AK"), query, request, &util.RuntimeOptions{})
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"404"}) {
			return object, WrapErrorf(Error(GetNotFoundMessage("EventRule", id)), NotFoundMsg, ProviderERROR, fmt.Sprint(response["RequestId"]))
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *CloudMonitorServiceServiceV2) DescribeDescribeEventRuleTargetList(id string) (object map[string]interface{}, err error) {
...
func (s *CloudMonitorServiceServiceV2) CloudMonitorServiceEventRuleStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := s.DescribeCloudMonitorServiceEventRule(id)
		if err != nil {
...
// DescribeCloudMonitorServiceEventRule >>> Encapsulated.
