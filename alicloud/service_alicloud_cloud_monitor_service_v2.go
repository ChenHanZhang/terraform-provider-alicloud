...
// DescribeCloudMonitorServiceDynamicTagGroup <<< Encapsulated get interface for CloudMonitorService DynamicTagGroup.

func (s *CloudMonitorServiceServiceV2) DescribeCloudMonitorServiceDynamicTagGroup(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	if len(v.([]interface{})) == 0 {
		return object, WrapErrorf(NotFoundErr("DynamicTagGroup", id), NotFoundMsg, response)
	}

	return v.([]interface{})[0].(map[string]interface{}), nil
}

func (s *CloudMonitorServiceServiceV2) CloudMonitorServiceDynamicTagGroupStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.CloudMonitorServiceDynamicTagGroupStateRefreshFuncWithApi(id, field, failStates, s.DescribeCloudMonitorServiceDynamicTagGroup)
}

func (s *CloudMonitorServiceServiceV2) CloudMonitorServiceDynamicTagGroupStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeCloudMonitorServiceDynamicTagGroup >>> Encapsulated.
