...
resource "alicloud_log_project" "defaultAJLKfI" {
  description = "for cloudspec resource test"
  name        = "cloudspectest-1511928242963727"
}

resource "alicloud_actiontrail_trail" "defaultJDHKFQ" {
  event_rw                = "Write"
  sls_project_arn         = "acs:log:cn-hangzhou:1511928242963727:project/cloudspectest-1511928242963727"
