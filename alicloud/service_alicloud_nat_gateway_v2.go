...
// DescribeNATGatewayNatGateway <<< Encapsulated get interface for NATGateway NatGateway.

func (s *NATGatewayServiceV2) DescribeNATGatewayNatGateway(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *NATGatewayServiceV2) DescribeNatGatewayGetNatGatewayAttribute(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	addDebug(action, response, request)
	if err != nil {
		if IsExpectedErrors(err, []string{"Invalid%s.NotFound"}) {
			return object, WrapErrorf(NotFoundErr("NatGateway", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *NATGatewayServiceV2) NATGatewayNatGatewayStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.NATGatewayNatGatewayStateRefreshFuncWithApi(id, field, failStates, s.DescribeNATGatewayNatGateway)
}

func (s *NATGatewayServiceV2) NATGatewayNatGatewayStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
		...
		object["InstanceChargeType"] = convertNATGatewayNatGatewayNatGatewaysNatGatewayInstanceChargeTypeResponse(object["InstanceChargeType"])
		v, err := jsonpath.Get(field, object)
		currentStatus := fmt.Sprint(v)
...
// DescribeNATGatewayNatGateway >>> Encapsulated.
