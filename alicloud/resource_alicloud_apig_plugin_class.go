...
func resourceAliCloudApigPluginClassCreate(d *schema.ResourceData, meta interface{}) error {
	...
	stateConf := BuildStateConf([]string{}, []string{"Failed"}, d.Timeout(schema.TimeoutCreate), 10*time.Second, apigServiceV2.ApigPluginClassStateRefreshFunc(d.Id(), "publishStatus", []string{}))
