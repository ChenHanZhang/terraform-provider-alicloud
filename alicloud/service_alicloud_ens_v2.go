...
func (s *EnsServiceV2) EnsLoadBalancerHTTPListenerStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.EnsLoadBalancerHTTPListenerStateRefreshFuncWithApi(id, field, failStates, s.DescribeEnsLoadBalancerHTTPListener)
}

func (s *EnsServiceV2) EnsLoadBalancerHTTPListenerStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
