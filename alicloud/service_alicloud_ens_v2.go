...
func (s *EnsServiceV2) EnsBucketLifecycleStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.EnsBucketLifecycleStateRefreshFuncWithApi(id, field, failStates, s.DescribeEnsBucketLifecycle)
}

func (s *EnsServiceV2) EnsBucketLifecycleStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
