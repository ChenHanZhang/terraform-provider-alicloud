...
// DescribeEnsLoadBalancerTCPListener <<< Encapsulated get interface for Ens LoadBalancerTCPListener.
...
func (s *EnsServiceV2) EnsLoadBalancerTCPListenerStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.EnsLoadBalancerTCPListenerStateRefreshFuncWithApi(id, field, failStates, s.DescribeEnsLoadBalancerTCPListener)
}

func (s *EnsServiceV2) EnsLoadBalancerTCPListenerStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
