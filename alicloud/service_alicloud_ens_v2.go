...
// DescribeEnsCommonBandwidthPackage <<< Encapsulated get interface for Ens CommonBandwidthPackage.

func (s *EnsServiceV2) DescribeEnsCommonBandwidthPackage(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *EnsServiceV2) EnsCommonBandwidthPackageStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.EnsCommonBandwidthPackageStateRefreshFuncWithApi(id, field, failStates, s.DescribeEnsCommonBandwidthPackage)
}

func (s *EnsServiceV2) EnsCommonBandwidthPackageStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeEnsCommonBandwidthPackage >>> Encapsulated.
